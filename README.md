...
- Hosting web pages with varying scripts and styling as a digital playground to learn and experiment with new things.
  - Current index page is heavily inspired by [Demonin's Item Shop's Index Page](https://demonin.com/) <[Github](https://github.com/DemoninCG)>, modifying their shader script to maintain that same oscilating lava-lamp feel but with more depth.
...
- Upload server backups to Google Cloud storage.
